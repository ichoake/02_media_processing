...
from TextToSpeech import TextToSpeech  # Importing tts @dataclass
class to make mp3 of posts
...
class Config:
    ...
    RedditScrape, 
)  # Importing reddit scraping @dataclass
class to acquire posts and authors
