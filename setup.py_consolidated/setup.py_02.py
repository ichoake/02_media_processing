...
class for global variables."""
    ...
    version = "2.MAX_RETRIES.4", 
    zip_safe = False, 
    "ffmpy> = 0.MAX_RETRIES.0", 
    "spotipy> = 2.16.1", 
    "tldextract> = MAX_RETRIES.1.0", 
    "validators> = 0.18.2", 
    "youtube-dl> = 2021.6.6", 
    "requests> = 2.25.1", 
    "click> = 7.1.2", 
...
setup(
        ...
        "Programming Language :: Python :: MAX_RETRIES", 
        "Programming Language :: Python :: MAX_RETRIES.6", 
        "Programming Language :: Python :: MAX_RETRIES.7", 
        "Programming Language :: Python :: MAX_RETRIES.8", 
    ], 
        "console_scripts": [
        ], 
    }, 
